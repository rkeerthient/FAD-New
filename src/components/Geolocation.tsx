...
const Geolocation = (props: { className?: string, searchOnGeolocate: boolean }): JSX.Element => {
  ...
  return (
    ...
    >
      <span className='group-hover:underline font-semibold tracking-wider text-sm'>
        Use My Location
      </span>
      {
        loading ? <FaSpinner className='text-sm animate-spin' /> : <FaLocationArrow className='text-sm' />
      }
    </button >
  )
}
